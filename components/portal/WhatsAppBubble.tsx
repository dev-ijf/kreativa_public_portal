...
export function WhatsAppBubble({ href = null, hrefBySchoolId, liftForCart = false }: Props) {
  ...
  return (
    <a
      ...
      className={[
        'fixed right-6 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe57] transition-[colors,bottom]',
        lift ? 'bottom-20' : 'bottom-6',
      ].join(' ')}
      aria-label="WhatsApp"
    >
      <WhatsAppIcon />
