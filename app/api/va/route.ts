...
type HandlerFn = (payload: Record<string, unknown>, debug: boolean) => Promise<Response>;

const VALID_METHODS = ['ECHO', 'INQUIRY', 'PAYMENT', 'SIGNON', 'SIGNOFF'] as const;
...
async function handleEcho(payload: Record<string, unknown>, debug: boolean): Promise<Response> {
  const { ECHODATE } = payload as Record<string, string>;
...
async function handleSignon(payload: Record<string, unknown>, debug: boolean): Promise<Response> {
  const { SIGNONINFO } = payload as Record<string, string>;
...
async function handleSignoff(payload: Record<string, unknown>, debug: boolean): Promise<Response> {
  const { SIGNOFFINFO } = payload as Record<string, string>;
...
async function handleInquiry(payload: Record<string, unknown>, debug: boolean): Promise<Response> {
  const { CCY, VANO } = payload as Record<string, string>;
...
async function handlePayment(payload: Record<string, unknown>, debug: boolean): Promise<Response> {
  const {
