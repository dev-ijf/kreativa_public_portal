...
import { getSecondaryDailySummaryRange } from '@/lib/data/server/secondary-daily';
...
export async function GET(request: Request) {
  ...
  const summary = await getSecondaryDailySummaryRange(userId, role, studentId, from, to);
  if (summary === null) {
